...
export interface MintedCrowdsaleImplInterface extends utils.Interface {
  functions: {
...
export interface MintedCrowdsaleImpl extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MintedCrowdsaleImplInterface;
