...
export interface SampleCrowdsaleTokenInterface extends utils.Interface {
  functions: {
...
export interface SampleCrowdsaleToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SampleCrowdsaleTokenInterface;
