...
export interface ERC721MetadataMintableInterface extends utils.Interface {
  functions: {
...
export interface ERC721MetadataMintable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721MetadataMintableInterface;
