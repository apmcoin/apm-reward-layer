...
export interface SampleCrowdsaleInterface extends utils.Interface {
  functions: {
...
export interface SampleCrowdsale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SampleCrowdsaleInterface;
