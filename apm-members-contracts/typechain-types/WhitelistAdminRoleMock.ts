...
export interface WhitelistAdminRoleMockInterface extends utils.Interface {
  functions: {
    "renounceWhitelistAdmin()": FunctionFragment;
    "onlyWhitelistAdminMock()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "onlyWhitelistAdminMock",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface WhitelistAdminRoleMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WhitelistAdminRoleMockInterface;
  ...
  functions: {
    ...
    onlyWhitelistAdminMock(overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
    ...
    onlyWhitelistAdminMock(overrides?: CallOverrides): Promise<BigNumber>;
