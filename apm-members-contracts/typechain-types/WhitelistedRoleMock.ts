...
export interface WhitelistedRoleMockInterface extends utils.Interface {
  functions: {
    ...
    "onlyWhitelistedMock()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "onlyWhitelistedMock",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface WhitelistedRoleMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WhitelistedRoleMockInterface;
  ...
  functions: {
    ...
    onlyWhitelistedMock(overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
    ...
    onlyWhitelistedMock(overrides?: CallOverrides): Promise<BigNumber>;
