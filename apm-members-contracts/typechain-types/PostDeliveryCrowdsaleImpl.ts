...
export interface PostDeliveryCrowdsaleImplInterface extends utils.Interface {
  functions: {
...
export interface PostDeliveryCrowdsaleImpl extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PostDeliveryCrowdsaleImplInterface;
