...
export interface MintedCrowdsaleInterface extends utils.Interface {
  functions: {
...
export interface MintedCrowdsale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MintedCrowdsaleInterface;
