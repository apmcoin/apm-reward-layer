...
export interface ERC20MintableMockInterface extends utils.Interface {
  functions: {
...
export interface ERC20MintableMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20MintableMockInterface;
