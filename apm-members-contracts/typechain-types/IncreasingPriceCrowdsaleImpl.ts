...
export interface IncreasingPriceCrowdsaleImplInterface extends utils.Interface {
  functions: {
...
export interface IncreasingPriceCrowdsaleImpl extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IncreasingPriceCrowdsaleImplInterface;
