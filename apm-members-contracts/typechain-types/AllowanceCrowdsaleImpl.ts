...
export interface AllowanceCrowdsaleImplInterface extends utils.Interface {
  functions: {
...
export interface AllowanceCrowdsaleImpl extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AllowanceCrowdsaleImplInterface;
