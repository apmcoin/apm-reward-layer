...
export interface ERC721MintableBurnableImplInterface extends utils.Interface {
  functions: {
...
export interface ERC721MintableBurnableImpl extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721MintableBurnableImplInterface;
