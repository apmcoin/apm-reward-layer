...
export interface RefundableCrowdsaleImplInterface extends utils.Interface {
  functions: {
...
export interface RefundableCrowdsaleImpl extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RefundableCrowdsaleImplInterface;
