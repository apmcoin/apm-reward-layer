...
export interface RefundablePostDeliveryCrowdsaleImplInterface
...
export interface RefundablePostDeliveryCrowdsaleImpl extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RefundablePostDeliveryCrowdsaleImplInterface;
