...
export interface RefundableCrowdsaleInterface extends utils.Interface {
  functions: {
...
export interface RefundableCrowdsale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RefundableCrowdsaleInterface;
