...
export interface SignatureBouncerInterface extends utils.Interface {
  functions: {
...
export interface SignatureBouncer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SignatureBouncerInterface;
